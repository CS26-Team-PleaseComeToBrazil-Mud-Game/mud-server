...
class World:
    ...
    def dfs_backtracker(self, size_x, size_y):
        ...
        start_room = grid[start_coords[0]][start_coords[1]] = Room(str(
            uuid4()), 'Start room', 'the adventurer begins their journey', start_coords[0], start_coords[1])
        # push cell to stack
        ...
        while len(stack):
            ...
            # randomly choose a neighbor that is empty
            # big_num = (len(empty_neighbors) - 1) if len(empty_neighbors) > 1
            ...
            # create a Room in emtpy_cell
            new_room = grid[empty_cell[0]][empty_cell[1]] = Room(
                str(uuid4()), '', '', empty_cell[0], empty_cell[1])

            # connect the current room to the new room
            new_room.connect_rooms(current_room, empty_cell[2])
...
#     # check above
#     try:
#         if grid[current.x][current.y - 1] == None:
#             empty_neighbors.append((current.x, current.y - 1, 'n'))
#     except:
#         pass
#     # check below
#     try:
#         if grid[current[0]][current[1] + 1] == None:
#             empty_neighbors.append((current[0], current[1] + 1, 's'))
#     except:
#         pass
#     # check left
#     try:
#         if grid[current[0] - 1][current[1]] == None:
#             empty_neighbors.append((current[0] - 1, current[1], 'w'))
#     except:
#         pass
...
#     try:
#         if grid[current[0] + 1][current[1]] == None:
#             empty_neighbors.append((current[0] + 1, current[1], 'e'))
#     except:
#         pass
